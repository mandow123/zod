...
const styles = StyleSheet.create({
  ...
  waiting: { borderColor: '#B9D2F7', backgroundColor: colors.primarySoft }, success: { borderColor: '#B8DEC2', backgroundColor: '#F6FCF7' }, danger: { borderColor: '#ECC0BD', backgroundColor: '#FFF8F7' }, muted: { backgroundColor: colors.canvas },
  ...
  acceptance: { padding: 13, marginTop: 12, borderWidth: 1, borderColor: '#B9D2F7', borderRadius: 15, backgroundColor: colors.primarySoft }, acceptanceSuccess: { borderColor: '#B8DEC2', backgroundColor: '#F6FCF7' }, acceptanceTop: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 8 }, acceptanceTitle: { flex: 1, color: colors.ink, fontSize: 12, fontWeight: '900' }, acceptanceDeadline: { color: colors.amber, fontSize: 8, fontWeight: '900' }, acceptanceText: { color: colors.muted, fontSize: 9, lineHeight: 16, marginTop: 7 },
