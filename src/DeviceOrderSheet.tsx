...
const styles = StyleSheet.create({
  ...
  summary: { padding: 15, borderRadius: 12, flexDirection: 'row', justifyContent: 'space-between', backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.line }, supplier: { color: colors.muted, fontSize: 10, fontWeight: '800' }, price: { color: colors.ink, fontSize: 23, fontWeight: '900', marginTop: 3 }, credit: { color: colors.primary, fontSize: 11, fontWeight: '800', marginTop: 5 }, stock: { alignItems: 'center', justifyContent: 'center', minWidth: 62 }, stockValue: { color: colors.ink, fontSize: 22, fontWeight: '900' }, stockLabel: { color: colors.muted, fontSize: 9, marginTop: 4 },
  warning: { padding: 12, marginTop: 10, borderRadius: 12, flexDirection: 'row', gap: 8, backgroundColor: colors.primarySoft }, warningText: { flex: 1, color: colors.muted, fontSize: 10, lineHeight: 16 }, error: { padding: 12, marginTop: 10, borderRadius: 12, flexDirection: 'row', gap: 8, backgroundColor: '#FDECEC' }, errorText: { flex: 1, color: colors.red, fontSize: 10, lineHeight: 16 },
