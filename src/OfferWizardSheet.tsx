...
const styles = StyleSheet.create({
  ...
  footer: { minHeight: 74, paddingHorizontal: 17, paddingTop: 10, paddingBottom: 10, borderTopWidth: 1, borderTopColor: colors.line, backgroundColor: colors.surface, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, secondaryButton: { height: 48, paddingHorizontal: 14, borderRadius: 12, borderWidth: 1, borderColor: colors.line, flexDirection: 'row', gap: 7, alignItems: 'center', backgroundColor: colors.canvas }, secondaryText: { color: colors.ink, fontSize: 12, fontWeight: '900' }, nextButton: { height: 48, paddingHorizontal: 18, borderRadius: 12, borderWidth: 1, borderColor: colors.primary, flexDirection: 'row', gap: 8, alignItems: 'center', backgroundColor: colors.primary }, nextText: { color: colors.surface, fontSize: 12, fontWeight: '900' },
