...
export function CreditScreen({ snapshot, refreshing, onRefresh, onLogin, onOpenWallet, onOpenPayout }: Props) {
  ...
  const quicklineAvailable = snapshot.qixiangTopupCapability !== null || distributionPolicy.stagingDemo;
...
const styles = StyleSheet.create({
  ...
  heading: { minHeight: 62, flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between' }, title: { color: colors.ink, fontSize: 25, fontWeight: '900' }, subtitle: { color: colors.muted, fontSize: 10, marginTop: 5 },
  ...
  primary: { minHeight: 44, paddingHorizontal: 16, alignItems: 'center', justifyContent: 'center', ...ledgerActionButton }, primaryText: { ...ledgerActionText, fontSize: 12, fontWeight: '900' }, secondary: { minHeight: 44, paddingHorizontal: 14, borderWidth: 1, borderColor: '#B7CEF4', borderRadius: 12, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.surface }, secondaryText: { color: colors.primary, fontSize: 11, fontWeight: '900' },
