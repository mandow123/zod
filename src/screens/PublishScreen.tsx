...
const styles = StyleSheet.create({
  ...
  progressLoadCard: { minHeight: 150, padding: 22, alignItems: 'center', justifyContent: 'center' }, progressLoadTitle: { color: colors.ink, fontSize: 16, fontWeight: '900', marginTop: 10 }, progressLoadText: { color: colors.muted, fontSize: 12, lineHeight: 18, textAlign: 'center', marginTop: 8 }, retryButton: { minHeight: 46, marginTop: 14, paddingHorizontal: 20, borderRadius: 14, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.primary }, retryText: { color: colors.surface, fontSize: 13, fontWeight: '900' },
  syncNotice: { minHeight: 48, marginBottom: 10, paddingHorizontal: 12, paddingVertical: 9, borderRadius: 14, flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: '#FFF8E7' }, syncNoticeText: { flex: 1, color: colors.muted, fontSize: 11, lineHeight: 17 }, syncRetry: { color: colors.primary, fontSize: 11, fontWeight: '900' },
