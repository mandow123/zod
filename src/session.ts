...
import { finishStoredAuthenticationCommit } from './auth-refresh';
...
export function reconcileCommittedKaiOidcSession(session: StoredSession) {
  return finishStoredAuthenticationCommit(session, clearVerifiedKaiIdentity);
}
